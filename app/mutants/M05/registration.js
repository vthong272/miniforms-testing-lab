// M05: Password confirmation is ignored in the acceptance decision
...
export function validateRegistration(input) {
  ...
  return { accepted: errors.filter((error) => error !== "Password and confirmation must match.").length === 0, errors };
}
